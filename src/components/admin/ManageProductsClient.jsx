                    ...
                    <div className="rounded-3xl max-w-md modal-box">
                        ...
                        <form onSubmit={handleUpdate} className="space-y-3">
                            ...
                            <div className="modal-action">
                                <button type="button" onClick={() => setEditingProduct(null)} className="rounded-xl btn btn-sm">
                                    Cancel
                                </button>
                                <button type="submit" className="rounded-xl text-white btn btn-primary btn-sm">
                                    Save Changes
                                </button>
                            </div>
                        </form>
