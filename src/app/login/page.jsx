        ...
        <div className="flex justify-center items-center my-8 px-4 min-h-[80vh]">
            <div className="flex flex-col items-center bg-white shadow-sm p-8 border border-slate-100 rounded-3xl w-full max-w-md">
                ...
                <form className="space-y-5 w-full">
                    ...
                    <div className="space-y-1">
                        <div className="flex justify-between items-center">
                            ...
                            <Link href="#" className="font-semibold text-primary text-xs hover:underline">Forgot Password?</Link>
                        </div>
                        <div className="relative flex items-center">
                    ...
                    <button 
                        type="submit" 
                        className="bg-primary hover:bg-primary/90 shadow-lg shadow-primary/10 mt-2 py-3.5 rounded-2xl w-full font-bold text-white text-base active:scale-[0.98] transition-all"
                    >
                        Sign In
                    </button>
                </form>
                ...
                <div className="relative flex items-center my-2 py-5 w-full">
                    ...
                    <span className="flex-shrink mx-4 font-medium text-slate-400 text-xs uppercase tracking-wider">Or continue with</span>
                    <div className="flex-grow border-slate-100 border-t"></div>
                </div>
